...
export const FAQ_ITEMS: FaqItem[] = [
  { q: 'What is a Hinglish to Hindi converter?', a: 'It is a specialized tool that takes Roman script Hinglish (e.g., "aap kaise ho") and instantly converts it into standard Devanagari Hindi script (e.g., "आप कैसै हें").' },
